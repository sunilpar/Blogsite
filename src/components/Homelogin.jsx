...
function Homelogin() {
  return (
    <section class="bg-white dark:bg-[#000000] flex flex-wrap h-screen pb-20 ">
      <div class="gap-16 items-center  py-8 px-4 mx-auto  lg:grid lg:grid-cols-2 lg:py-16 lg:px-6  ">
        <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
          ...
          <p class="mb-4 text-3xl flex justify-center">
        ...
        <div class="flex justify-center mt-8 flex-wrap  ">
          <div class="flex  gap-4 flex-direction-row justify-center  items-center mt-8 text-gray-500 sm:justify-between">
            <div>
              <a
                target="_blank"
                href="http://www.melamchiwater.gov.np/about-us/melamchi-ws-project/project-description/"
              >
                <article class="relative isolate flex flex-col justify-end overflow-hidden rounded-xl p-6 pt-10 pb-8  max-w-sm mx-auto mt-2 hover:scale-105 ">
                  <img
                  ...
                  <h3 class="z-10 mt-3 text-lg font-bold text-white">
